...
int main() {
    ...
    while (1) {  // Loop principal do programa
        ...
        printf("3 - Comparar Cidades (somente população)\n");
        printf("4 - Sair\n");
        ...
        switch (opcao) {
            ...
            case '3': {  // Comparar cidades (somente população)
                ...
                // Compara as duas cidades pela população
                compararCidades(&estados[estado1 - 'A'].cidades[cidade1_num - 1],
                                &estados[estado2 - 'A'].cidades[cidade2_num - 1]);
                break;
            }
