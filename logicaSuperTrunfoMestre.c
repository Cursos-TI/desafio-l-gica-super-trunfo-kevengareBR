...
// Função para comparar duas cidades com base em dois critérios
void compararCidades(Cidade *cidade1, Cidade *cidade2, int criterio1, int criterio2) {
    int pontos_cidade1 = 0;
    int pontos_cidade2 = 0;

    printf("\n--- Comparação de Cidades ---\n");

    // Comparar primeiro critério
    switch (criterio1) {
    ...
    if (pontos_cidade1 > pontos_cidade2) {
        printf("Cidade %s vence com %d pontos!\n", cidade1->nome, pontos_cidade1);
    } else if (pontos_cidade1 < pontos_cidade2) {
        printf("Cidade %s vence com %d pontos!\n", cidade2->nome, pontos_cidade2);
    } else {
        printf("Empate! Ambas as cidades são incríveis!\n");
    }
}
    ...
    while (1) {  // Loop principal do programa
        ...
        switch (opcao) {
            ...
            case '3': {  // Comparar cidades
                ...
                int cidade1_num, cidade2_num, criterio1, criterio2;
                ...
                // Escolhe os critérios de comparação
                ...
                printf("\nEscolha o segundo critério de comparação:\n");
                printf("1 - População\n");
                printf("2 - Área\n");
                printf("3 - PIB\n");
                printf("4 - Pontos turísticos\n");
                ...
                // Compara as duas cidades com base nos critérios escolhidos
                compararCidades(&estados[estado1 - 'A'].cidades[cidade1_num - 1],
                                &estados[estado2 - 'A'].cidades[cidade2_num - 1], criterio1, criterio2);
                break;
            }
